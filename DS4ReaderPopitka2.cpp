...
// DS4ReaderPopitka2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDS4ReaderPopitka2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CDS4ReaderPopitka2App

CDS4ReaderPopitka2App::CDS4ReaderPopitka2App()
{
...
// Единственный объект CDS4ReaderPopitka2App

CDS4ReaderPopitka2App theApp;


// Инициализация CDS4ReaderPopitka2App

BOOL CDS4ReaderPopitka2App::InitInstance()
{
